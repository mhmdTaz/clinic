...
describe('state shared across bundle copies', () => {
  it('a model in one copy sees the audit sink installed by another', async () => {
  ...
  it('the audit sink reads the request context that a route opened in another copy', async () => {
  ...
  it('a scope resolver registered at startup decides requests served by another copy', async () => {
